				...
				<div class="col-sm-12 topbar">
					<ul class="menu nav navbar-nav">
						...
						<?php 
							...
							<li><a href="tel:+16046893647"><span class="phonenumber">Phone us: 1-604-689-3647</span></a></li> 
 ...
 <?php print render($page['header']); ?>
  ...
  <div class="row">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <?php print $messages; ?><!-- MESSAGE HERE page--catalog-1 -->
      <?php if (!empty($tabs)): ?>
...
<?php endif; ?>
	...
	<script>
		...
		// Click on a filter to hide all filters.
		jQuery(".filterlist").click(function(){
			jQuery(this).slideUp("slow");
			jQuery(".reset").slideDown("slow");
		});

		
		// click on reset and it hides and filters return.
		jQuery(".reset").click(function(){
			jQuery(this).slideUp("slow");
			jQuery(".filterlist").slideDown("slow");
		});
		});
	</script>
