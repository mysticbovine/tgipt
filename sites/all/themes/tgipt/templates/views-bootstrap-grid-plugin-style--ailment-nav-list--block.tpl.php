...
<div id="views-bootstrap-grid-<?php print $id ?>" class="<?php print $classes ?>  filters filterlist">
...
<div class="filters col-xs-12">
	<span class="filter mini btn btn-lg btn-nutra reset" data-filter=".all">RESET ALL</span>
</div>